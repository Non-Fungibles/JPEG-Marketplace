...
router.patch('/markets/', /*api middeware here buy/sell logic here update price for nft and user id */)
...
router.post('/', /*api controller add NFTs*/ (req, res) => {
...
router.post('/users/login', userController.verifyUser, (req, res) =>{
...
router.post('/users/signup', userController.createUser, (req, res) => {
